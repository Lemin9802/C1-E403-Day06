...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------ | ---------------------------------------------------------------------------------------- |
| App Long Châu có **chat dược sĩ** và disclaimer _"chỉ mang tính tham khảo, không thay thế chẩn đoán"_ — chưa có luồng **tra cứu nhanh + Safety Card** trước khi chat | App Store / Play Store mô tả app                                    | Happy (baseline)         | Cơ hội: thêm lớp AI **chuẩn bị context** trước handoff dược sĩ                           |
| User muốn biết _"thuốc X có uống được khi đang Y không"_ thường phải **chờ dược sĩ online** hoặc tự Google — không có output chuẩn hóa                               | Self-use mô phỏng workflow: mở app → tìm thuốc → muốn hỏi tương tác | Failure / Low-confidence | Pain: thiếu **self-serve an toàn** ngoài giờ / trước khi mua                             |
